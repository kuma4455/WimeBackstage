...
<c:if test="${empty param.verifiedResultNo}">
	<meta http-equiv="refresh" content="3; url=${pageContext.servletContext.contextPath}/productList/selectAllProducts">
</c:if>
<title>驗證</title>
...
<script language="JavaScript">
	...
	function getSecs() {
		...
		mySecs1 = 3 - eval(mySecs1.substring(0, mySecs1.indexOf(".")))+ "秒後...頁面自動跳轉"; //算出倒數的時間
...
<body onLoad="window.setTimeout('getSecs()',1)">
	...
	<div>
			...
			<img src="<c:url value="/resources/images/yes1.png" />">
				<h1>產品  ${product.productName} 新增成功</h1>
				<h4>
