...
$('#show1').click(function(){
	...
	$('#memberDiv2').css('display','none');
	$('#memberDiv3').css('display','none');
	$('#memberDiv4').css('display','none');
